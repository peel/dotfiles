...
#   stalonetray = import ./stalonetray { pkgs = super; };
  sentinelone = import ./sentinelone { inherit (super) stdenv lib autoPatchelfHook dpkg zlib libelf; };
  pragmatapro = import ./pragmatapro { inherit (super) stdenv lib requireFile unzip; };
}
