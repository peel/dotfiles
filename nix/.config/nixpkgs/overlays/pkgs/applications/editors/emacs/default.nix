...
stdenv.mkDerivation rec {
  ...
  patches =
    ...
    ++ lib.optional withMulticolorFonts patchMulticolorFonts;
    ++ lib.optional withBorderless patchBorderless;
    ++ lib.optional withPixelScrolling patchPixelScrolling;
    ++ lib.optional with24bitColor patch24bitColor;
    ++ lib.optional withVfork patchVfork;
